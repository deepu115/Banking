...
describe('Accounts', () => {
    ...
    it('should have a balance of zero initially', () => {
        // Assert
    ...
    describe('Making a deposit', () => {
        ...
        it('should increase the balance when a valid deposit is made', () => {
            // Arrange
        ...
        it('should throw an error if the deposit amount exceeds the limit', () => {
            // Arrange
            const initialBalance = account.getBalance();
        ...
        it('should throw an error if the deposit amount is not greater than zero', () => {
            // Arrange
    ...
    describe('Making a withdrawal', () => {
        ...
        it('should decrease the balance when a valid withdrawal is made', () => {
            // Arrange
        ...
        it('should throw an error if the withdrawal amount is not a valid number', () => {
            // Arrange
            const initialBalance = 1000;
